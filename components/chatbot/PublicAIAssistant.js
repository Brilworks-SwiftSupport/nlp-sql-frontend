      ...
      <div className="bg-gray-900 border-t border-gray-700 p-4 shadow-lg">
        <form onSubmit={handleSendMessage} className="flex space-x-2">
          ...
          <button
            ...
            className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg px-4 py-3 font-medium hover:from-blue-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 transition-all shadow-glow-blue flex items-center justify-center"
          >
