              ...
              <dd>
                <div className="text-lg font-medium text-gray-900">
                  {connection.db_type === 'mysql' ? 'MySQL' : 
                   ...
                   connection.db_type === 'mongodb' ? 'MongoDB' : 
                   connection.db_type}
                </div>
              </dd>
            </dl>
          ...
          <dl className="grid grid-cols-1 gap-4">
            <div className="rounded-lg bg-gray-50 p-3">
              <div className="flex justify-between">
                ...
                <dd className="text-sm text-gray-900 text-right" title={`${connection.host}:${connection.port}`}>
            ...
            <div className="rounded-lg bg-gray-50 p-3">
              <div className="flex justify-between">
                ...
                <dd className="text-sm text-gray-900 text-right" title={connection.database}>
                  <div className="max-w-[180px] truncate">
                    {connection.database}
                  </div>
                </dd>
